...
namespace OOP4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //ICircle c = new Circle(2);
            //c.DisplayShapeInfo();
            //IRectangle r = new Rectangle(2,3);
            //r.DisplayShapeInfo();
            ...
            //IAuthenticationService BAS = new BasicAuthenticationService("mo","123","admin");
            //Console.WriteLine($"Authentication {BAS.AuthenticateUser("moo", "321")} ");
            //Console.WriteLine($"Authorization {BAS.AuthorizeUser("mo", "user")}");
            //Console.WriteLine($"Authentication {BAS.AuthenticateUser("mo", "123")} ");
            //Console.WriteLine($"Authorization {BAS.AuthorizeUser("mo", "admin")}" );
            ...
            //email.SendNotification("Mohamed", "Hi");
            //sms.SendNotification("Mona", "Hello");
            //push.SendNotification("Amr", "Low Battery");
